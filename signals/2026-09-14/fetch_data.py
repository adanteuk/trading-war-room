#!/usr/bin/env python3
"""Fetch NAS100 (+US500 for SMT) data from Carson MT5 bridge for Walker TA analysis."""
import zmq, json, sys, datetime

HOSTS = ["tcp://192.168.11.173:5555", "tcp://192.168.11.172:5555"]
OUT_DIR = "/Users/ychen/.hermes/trading-war-room/signals/2026-09-14"
import os
...
def main():
    ...
    if not host:
        ...
        sys.exit(0)
    # v2.2 responses carry time_epoch / time_utc / time_ny / time_hkt per bar
    datasets = {
